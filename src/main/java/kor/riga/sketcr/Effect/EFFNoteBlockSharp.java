...
public class EFFNoteBlockSharp extends Effect {
    ...
    public String toString(Event event, boolean b) {
        return "play noteblock sharp instrument %string% and tone %string% at %location% to %player%";
    }
    ...
    protected void execute(Event event) {
        ...
        player.playNote(loc, Instrument.valueOf(ins.toUpperCase()), Note.sharp(1, tone));
